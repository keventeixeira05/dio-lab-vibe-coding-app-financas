...
Este projeto foi desenvolvido como un Desafio de Projeto da DIO de Vibe Coding utilizando o Lovable e o Copilot Meb. A proposta é criar un aplicativo de organização financeirs pessoal baseado en interações en linguagem natural.

---

# PRD Redefinido no copilot web 
...
<img width="1862" height="962" alt="image" src="https://github.com/user-attachments/assets/c6cf431e-e9c9-420e-9adf-e74a0ccc6700" />

---

# 📱 App de Organização de Finanças Pessoais (Conversacional)

Aplicativo de controle financeiro pessoal baseado em **conversas em linguagem natural**, criado para tornar a organização financeira **simples, acessível e inclusiva**, seguindo os princípios de **Design Universal**.

O app elimina a necessidade de planilhas ou formulários complexos, permitindo que qualquer pessoa controle seus gastos e metas de forma intuitiva.
...
### 🗨️ Interação Conversacional (Chat)
